                ...
                <div className='font-bold text-2xl'>
                    ...
                    <div className='space-y-2'>
                        ...
                        friends.map((friend, index) => (
                            <FriendComponent key={index} name={friend.primaryName} add={true} remove={false}/>
                        ))}
                    </div>
                </div>
                <div className='font-bold text-2xl'>
                    ...
                    <div className='space-y-2'>
                        ...
                        recommendations.map((recommendation, index) => (
                            <FriendComponent key={index} name={recommendation.primaryName} add={true} remove={false}/>
                         ))}
                    </div>
                </div>
            </div>
